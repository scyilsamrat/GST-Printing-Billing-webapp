...
def checker(request):
    ...
    if request.method == "POST":
        ...
        sheet.merge_cells(start_row=l+23, start_column=1, end_row=l+23, end_column=10)
        sheet.cell(row=l+23, column=1).value="----A Web Billing  Software Solution by Scyil Pvt Ltd Guna 9009323236----"
        sheet.cell(row=l+23, column=1).alignment = ali
        sheet.cell(row=l+23, column=1).font = fontScyil
